       ...
       <div id="preloader">
        ...
        <section class="most_popular_item_area menu_list_page">
            <div class="container">
                ...
                <h1>SELECT SECOND SAUCE FOR TABLE: <?php
                ...
                <div class="p_recype_item_main">
                    <div class="row p_recype_item_active">
                        <?php
                            ...
                            $sql = "SELECT id, itemname, picture FROM $saucemenu ORDER BY id";
                            $result = mysqli_query($conn, $sql);


                            while($saucemenu = mysqli_fetch_assoc($result)) {
                                $id = $saucemenu['id'];
                                $itemname = $saucemenu['itemname'];
                                $picture = $saucemenu['picture'];
                                ?>
                            ...
                            <div class="feature_item">
                                <div class="feature_item_inner">
                                    ...
                                    <div class="icon_hover">
                                        <form action="updates/updatesauce2.php" method="post">

                    ...
                    <div class="row p_recype_item_active">
                        <?php
                            ...
                            <div class="feature_item">
                                ...
                                <div class="title_text">
                                    <div class="feature_left"><a href="#"><span>ADD TO TABLE <?php echo htmlspecialchars($ordernum); ?></span></a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6 indoor">
                        ...
                        <div class="col-md-4 col-sm-6 indoor">
                            <div class="feature_item">
                                ...
                                <div class="title_text">
                                    <div class="feature_left"><a href="#"><span>CURRENT ORDER FOR TABLE <?php echo htmlspecialchars($ordernum); ?></span></a></div>
                                </div>
                            </div>
                        </div></h1>
                    </div>
